...
import {
  CreateDistributionManagementDto
} from "@modules/distribution-management/dto/create-distribution-management.dto";
...
export class DistributionAgentController {
  ...
  @UseGuards(AuthGuard)
  @UseGuards(RoleGuard(Role.DistributionAgent))
  async getAll(@Query() options: PaginationParamsDto, @AccountDecorator() account: AccountDocument) {
